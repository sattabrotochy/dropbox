...
import 'package:flutter_dropbox/demo.dart';
import 'package:path_provider/path_provider.dart';
import 'package:shared_preferences/shared_preferences.dart';

const String dropbox_clientId = 'demo_flutter';
const String dropbox_key = 'nh0mtiikcl799cz';
const String dropbox_secret = '0lo5hh3gbsqim47';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  MaterialApp(home: DemoFileUpload());
  }
}
...
class _HomeState extends State<Home> {
  ...
  Future uploadTest() async {
    if (await checkAuthorized(true)) {
      ...
      final result =
      await Dropbox.upload(filepath, '', (uploaded, total) {
